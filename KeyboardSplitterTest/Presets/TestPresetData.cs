...
//            this.testPreset.Dpads.Add(new PresetDpad(XboxDpadDirection.Right, "Zero"));
...
//            Assert.IsTrue(deserializedPreset.Dpads[0].Direction == XboxDpadDirection.Right);
//            Assert.IsTrue(deserializedPreset.Dpads[0].KeyboardKey == "Zero");
